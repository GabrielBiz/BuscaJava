 ...
 *
 * Representa um estado do mundo: o nro que esta em cada posicao do quadro.
 *
 * Nesta solucao o estado inicial e o quadro sem numeros e, a cada sucessor, um
 * novo numero e incluido.
 */
public class QuadradoMagico implements Estado, Heuristica {

	public String getDescricao() {
		return "Um quadrado magico de ordem n e um arranjo quadrado de n^2 inteiros\n"
	...
	/**
	 * gera uma lista de sucessores do nodo. (coloca mais um numero no
	 * tabuleiro)
	 */
	...
	/**
	 * o desvio das somas das linhas, colunas, diagonais em relacao ao objetivo
	 */
	public int h() {
		if (this.h >= 0) {
			return h;
